  ...
  render() {
    ...
    return (
      ...
      <form onSubmit={this.handleSubmit}>
        ...
        <input placeholder="handicap" type="number" name="handicap" value={formData.handicap} onChange={this.handleChange} /><br/>
        <input placeholder="total" type="number" min="0" name="total" value={formData.total} onChange={this.handleChange} /><br/>
        <input placeholder="2019-09-05" type="text" name="day" value={formData.day} onChange={this.handleChange} /><br/>
        <input placeholder="13:30" type="text" name="time" value={formData.time} onChange={this.handleChange} /><br/>
